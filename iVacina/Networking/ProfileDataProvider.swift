...
class ProfileProvider {
    ...
    var pessoa: Titular = Titular(nome: "Alan Silva", email: "", imagem: "", grupo: .Adulto, tipoSanguineo: .A, hipertenso: false, diabetico: false, doadorOrgaos: false, pcd: false,listaVacinas: [
...
Vacina(nome: "Influenza", grupo: .Gestante, status: false)],dependentes: [])
                                  
var dependente: Pessoa = Pessoa(nome: "Davi Silva", imagem: "davi.jpg", grupo: .Crianca, tipoSanguineo: .A, hipertenso: false, diabetico: false, doadorOrgaos: false, pcd: false, listaVacinas:[
Vacina(nome: "BCG", grupo: .Crianca, status: false),
Vacina(nome: "Hepatite_B", grupo: .Crianca, status: false),
Vacina(nome: "Penta_1_Dose", grupo: .Crianca, status: false),
Vacina(nome: "Poliomielite_1_Dose", grupo: .Crianca, status: false),
...
var dependente0: Pessoa = Pessoa(nome: "Carol Silva", imagem: "alan@gmail.com", grupo: .Crianca, tipoSanguineo: .A, hipertenso: false, diabetico: false, doadorOrgaos: false, pcd: false, listaVacinas:[
Vacina(nome: "BCG", grupo: .Crianca, status: false),
Vacina(nome: "Hepatite_B", grupo: .Crianca, status: false),
Vacina(nome: "Penta_1_Dose", grupo: .Crianca, status: false),
Vacina(nome: "Poliomielite_1_Dose", grupo: .Crianca, status: false),
...
Vacina(nome: "Influenza", grupo: .Gestante, status: false)])
        ...
        func getTitular() -> Titular{
            ...
            self.pessoa.dependentes.append(dependente)
            self.pessoa.dependentes.append(dependente0)
            return self.pessoa
